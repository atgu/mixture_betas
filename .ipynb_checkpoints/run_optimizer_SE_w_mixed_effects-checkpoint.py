...
# minimize function of single component if and only if the diptest is not significant (BF corrected in tissue)
       ...
       # final_cluster_names.append(counts_df_with_cluster_name_info.cluster_name.iloc[i])
        #j+=1
...
[est_alphas_and_betas_list, output_of_min_funcs, cluster_names_new, est_LL, sum_of_all_reads, est_LL_triple, est_LL_double, params_triple, params_double, p_values_for_LR_test,p_values_for_diptest ] = est_alphas_and_betas(alpha_counts,beta_counts, a, True,True, num_jobs, job_index)
...
output_df = output_df.assign(cluster_name = cluster_names)

print(output_df["cluster_names"]) 
