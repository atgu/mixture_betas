...
############################# 1. calculate empirical bayes using chosen method depending on diptest ############################
        ...
        #perform the EM algorithm with 2 components if the diptest is signficiant (assumption of unimodality can be rejected) 
        else:
            params, Log_Likelihood, minimized_a_b = est_mixture_of_alphas_and_betas_w_restarts(exon_a, exon_b, 2)
